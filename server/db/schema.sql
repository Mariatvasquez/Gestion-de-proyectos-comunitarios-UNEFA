...
INSERT INTO users (name, identification, major, role, password_hash, tutor_id) VALUES
('Prof. Rosa Camejo', 'V-10203040', 'Administración', 'coordinator', '$2b$10$hSMvAg7ZkTP2d5hKKmay/O6DjtsfqJZd0cpvgM.lGVqllfsuo7In6', NULL),
('Prof. Carlos Mendoza', 'V-8765432', 'Ingeniería de Sistemas', 'tutor', '$2b$10$hSMvAg7ZkTP2d5hKKmay/O6DjtsfqJZd0cpvgM.lGVqllfsuo7In6', NULL),
('Ana Gómez', 'V-25123456', 'Ingeniería de Sistemas', 'student', '$2b$10$hSMvAg7ZkTP2d5hKKmay/O6DjtsfqJZd0cpvgM.lGVqllfsuo7In6', 2),
('Luis Torres', 'V-26789123', 'Ingeniería de Sistemas', 'student', '$2b$10$hSMvAg7ZkTP2d5hKKmay/O6DjtsfqJZd0cpvgM.lGVqllfsuo7In6', 2);
...
-- Insertar hitos académicos
INSERT INTO milestones (title, event_date) VALUES
('Taller de Inducción de Servicio Comunitario', '2026-06-05'),
('Entrega del Primer Avance de Bitácoras', '2026-06-25'),
('Entrega de Informe Final Firmado', '2026-07-20');
